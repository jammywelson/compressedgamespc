...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'About CompressedGamesPC — Your #1 source for highly compressed PC games.',
}
      ...
      <main style={{ maxWidth:'760px', margin:'0 auto', padding:'40px 24px' }}>
        ...
        <div style={{ fontSize:'15px', color:'#374151', lineHeight:1.8 }}>
          ...
          <ul style={{ paddingLeft:'20px', marginBottom:'16px', display:'flex', flexDirection:'column', gap:'6px' }}>
            {['Latest PC games highly compressed','Direct download links — no surveys, no ads','Fast download servers with multiple mirrors','Regular updates with new game releases','System requirements for every game'].map(item => (
